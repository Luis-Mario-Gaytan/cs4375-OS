...
int main() {
  ...
  /*
  Comprehensive tests:
  1. Populate entire thing in blocks of for loop (a's, b's, c's, and d's) equal
  size.
  ...
  */
  ...
  char stringA[1024], stringB[1024], stringC[1024], stringD[1024],
      stringX[1024];
  ...
  stringA[1023] = stringB[1023] = stringC[1023] = stringD[1023] =
      stringX[1023] = '\0';
  ...
  if (strcmp(stringA, strA) == 0 && strcmp(stringB, strB) == 0 &&
    ...
    printf("Test 1 failed: A: %d, B: %d, C: %d, D: %d\n", strcmp(stringA, strA),
           strcmp(stringB, strB), strcmp(stringC, strC), strcmp(stringD, strD));
